...
var app = (function () {
    ...
    /* src\components\Signup.svelte generated by Svelte v3.29.0 */
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "sr-only");
    			add_location(h2, file$1, 99, 8, 2222);
    			attr_dev(i, "class", "icon ion-ios-locked-outline");
    			add_location(i, file$1, 100, 34, 2294);
    			attr_dev(div0, "class", "illustration svelte-2pbel3");
    			add_location(div0, file$1, 100, 8, 2268);
    			attr_dev(input0, "class", "form-control svelte-2pbel3");
    			attr_dev(input0, "type", "username");
    			attr_dev(input0, "name", "username");
    			attr_dev(input0, "placeholder", "Username");
    			add_location(input0, file$1, 101, 32, 2377);
    			attr_dev(div1, "class", "form-group");
    			add_location(div1, file$1, 101, 8, 2353);
    			attr_dev(input1, "class", "form-control svelte-2pbel3");
    			attr_dev(input1, "type", "email");
    			attr_dev(input1, "name", "email");
    			attr_dev(input1, "placeholder", "Email");
    			add_location(input1, file$1, 102, 32, 2524);
    			attr_dev(div2, "class", "form-group");
    			add_location(div2, file$1, 102, 8, 2500);
    			attr_dev(input2, "class", "form-control svelte-2pbel3");
    			attr_dev(input2, "type", "password");
    			attr_dev(input2, "name", "password");
    			attr_dev(input2, "placeholder", "Password");
    			add_location(input2, file$1, 103, 32, 2658);
    			attr_dev(div3, "class", "form-group");
    			add_location(div3, file$1, 103, 8, 2634);
    			attr_dev(button, "class", "btn btn-primary btn-block svelte-2pbel3");
    			attr_dev(button, "type", "submit");
    			add_location(button, file$1, 104, 32, 2804);
    			attr_dev(div4, "class", "form-group");
    			add_location(div4, file$1, 104, 8, 2780);
    			attr_dev(form, "class", "svelte-2pbel3");
    			add_location(form, file$1, 98, 4, 2164);
    			attr_dev(div5, "class", "login-dark svelte-2pbel3");
    			add_location(div5, file$1, 97, 5, 2134);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	let if_block_anchor;
    	let if_block = !/*hide*/ ctx[3] && create_if_block$1(ctx);
    ...
    /* src\components\Welcome.svelte generated by Svelte v3.29.0 */
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1mitjs9");
    			add_location(h1, file$2, 15, 5, 267);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1mitjs9");
    			add_location(h1, file$2, 13, 5, 213);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*data*/ ctx[0].Error) return create_if_block$2;
    		if (/*data*/ ctx[0].success) return create_if_block_1$1;
    	}
    ...
    function create_default_slot(ctx) {
    	...
    	route = new Route({
    			props: { path: "/welcome", component: Welcome },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$3, 10, 2, 233);
    			add_location(div, file$3, 17, 2, 356);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 8, 2, 194);
    			add_location(main, file$3, 6, 0, 173);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Signup, Router, Link, Route, Welcome });
    	return [];
    }
